...
ggplot(MCClist, aes(x=pEffComp)) +
  geom_histogram(aes(pEffComp="density"),
                 binwidth = .01,
                 colour = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
  labs(title = "Distribution of Effective Competition") +
...
qplot(pcService, pEffectiveComp, data = StateList, geom=c('point', 'smooth'), method = 'loess', ylab = "Effective Competition", xxlab = "Services")
