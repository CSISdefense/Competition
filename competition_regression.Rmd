...
afit <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ sqrt(pRnD)+ pAir, data=MCClist)
summary(afit) 
dfMCC<-LMsummaryLine(afit)
plot(afit)

bfit <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ sqrt(pAir), data=MCClist)
summary(bfit) 
dfMCC<-LMsummaryLine(bfit)
plot(bfit)

screenreg(list(afit, bfit))
...
fit1 <- lm(pEffectiveComp ~ pProduct+sqrt(pRnD)+ pAir+pVessel, data=MCClist)
summary(fit1) 
dfMCC<-rbind(dfMCC,LMsummaryLine(fit1))


fit2 <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ sqrt(pRnD)+ sqrt(pAir) +sqrt(pVessel), data=MCClist)
summary(fit2) 
...
afit1 <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ sqrt(pRnD)+ pAir + pLand, data=MCClist)
summary(afit1) 
dfMCC<-LMsummaryLine(afit1)
plot(afit1)


afit2 <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ sqrt(pRnD)+ sqrt(pAir) + sqrt(pLand), data=MCClist)
summary(afit2) 
dfMCC<-LMsummaryLine(afit2)
plot(afit2)
screenreg(list(afit1, afit2))
...
bfit1 <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ sqrt(pRnD)+ pAir + pMnS, data=MCClist)
summary(bfit1) 
...
bfit3 <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ pAir + pMnS  +pVessel, data=subset(MCClist,                                                                                    rownames(MCClist)!=58))
summary(bfit3) 
plot(bfit3)
screenreg(list(bfit1, bfit2, bfit3))
```
...
cfit1 <- lm(pEffectiveComp ~ pcService+I(pcService^2)+ pAir + pMnS +pWnA, data=MCClist)
summary(cfit1) 
plot(cfit1)
...
dfit1 <- lm(pEffectiveComp ~ I(pcService^2)+ pAir  +pMnS +pWnA +pEnC, data=MCClist)
summary(dfit1) 
plot(dfit1)

dfit2 <- lm(pEffectiveComp ~ I(pcService^2)+ pAir  +pMnS +pWnA +pLand+ pEnC, data=MCClist)
summary(dfit2) 
plot(dfit2)
screenreg(list(dfit1, dfit2))

dfit3 <- lm(pEffectiveComp ~ I(pcService^2)+ pAir  +pMnS +pWnA +pEnC +pVessel, data=subset(MCClist,
