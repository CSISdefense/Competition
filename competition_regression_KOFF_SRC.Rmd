...
fitA <- lm(pEffectiveComp ~ pProduct+ I(pProduct^2)+ pRnD+ pAir+ pFnC+ TotalValue+ Exclude+ pEnC+ pFixed+ TotalCount+ pLand+ wavOffers+ pCostPlus+ avSize+ pProduct+ pMnS+ pIncentFee+ pWnA+ pIDV+ MaxAnnualValue, data=KOfflist) 
...
fitB <- lm(pEffectiveComp ~ pProduct+ I(pProduct^2)+ pAir+ pFnC+ TotalCount+ pWnA+ avSize+ pFixed+ wavOffers+ pMnS+ pIDV, data=KOfflist)
summary(fitB)
