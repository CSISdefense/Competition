...
``` {r variable exploration singlecomp echo=TRUE}
...
``` {r Variable Exploration with effective competition echo=TRUE}
...
ggplot(MCClist, aes(x=pVehMAC)) +
  geom_histogram(aes(pVehMAC="density"),
                 ...
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
  labs(title = "Distribution of IDV MAC Contracts Obligated: MCC level") +
...
ggplot(MCClist, aes(x=pVehSAC)) +
  geom_histogram(aes(pVehSAC="density"),
                 ...
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
  labs(title = "Distribution of IDV SAC Contracts Obligated: MCC level") +
  labs(x = "IDV SAC Contracts Obligated") +
  geom_vline(aes(xintercept=vehMACsmean, color="blue"),
             linetype = "dashed", size = 1)
...
ggplot(StateList, aes(x=pVehSAC)) +
  geom_histogram(aes(pVehSAC="density"),
                 ...
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
  labs(title = "Distribution of IDV SAC Contracts Obligated: State level") +
  labs(x = "IDV SAC Contracts Obligated") +
