...
ECmeanSL <- mean(StateList$pEffectiveComp)

ggplot(StateList, aes(x=pEffectiveComp)) +
  geom_histogram(aes(pEffectiveComp="density"),
                 binwidth = .01,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
...
ServmeanSL <- mean(StateList$pService)

ggplot(StateList, aes(x=pService)) +
  geom_histogram(aes(pService="density"),
                 binwidth = .02,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
...
Airmeana <- mean(StateList$pAir)

ggplot(StateList, aes(x=pAir)) +
  geom_histogram(aes(pAirr="density"),
                 binwidth = .01,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
...
pscAirmean1 <- mean(MCClist$pPscAir)
...
WnAmeanb <- mean(StateList$pWnA)

ggplot(StateList, aes(x=pWnA)) +
  geom_histogram(aes(pWnA="density"),
                 binwidth = .005,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
...
EnCmeanb <- mean(StateList$pEnC)

ggplot(StateList, aes(x=pEnC)) +
  geom_histogram(aes(pEnC="density"),
                 binwidth = .01,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
...
MnSmeana <- mean(StateList$pMnS)

ggplot(StateList, aes(x=pMnS)) +
  geom_histogram(aes(pMnS="density"),
                 binwidth = .005,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
...
Shipsmean1 <- mean(StateList$pVessel)

ggplot(StateList, aes(x=pVessel)) +
  geom_histogram(aes(pVessel="density"),
                 binwidth = .01,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
...
Enginesmean1 <- mean(MCClist$pPscEngines)
...
Fixedmean1 <- mean(StateList$pFixed)

ggplot(StateList, aes(x=pFixed)) +
  geom_histogram(aes(pFixed="density"),
                 binwidth = .01,
                 color = "red", fill = "light blue", main = "HISTOGRAM") +
  geom_density(alpha = .2, fill = "#FF6666") +
