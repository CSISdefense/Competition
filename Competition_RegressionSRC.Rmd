...
boxplot(MCClist$pcService, col=(c("light blue", "light blue")), main = "Type of Good Procured: Service", xlab = "dollars spent on services", horizontal = TRUE)
...
boxplot(MCClist$pAir, col=(c("yellow", "yellow")), main = "Platform Portfolio: Air", xlab = "dollars spent on Air", horizontal = TRUE)
...
boxplot(MCClist$pWnA, col=(c("green", "green")), main = "Platform Portfolio: Weapons and Ammunition", xlab = "dollars spent on Weapons and Ammunition", horizontal = TRUE)

qplot(MCClist$pWnA, geom = "histogram", binwidth = .03, main = "Distribution of Weapons and Ammunition", xlab = "Platfor Portfolio: Weapons and Ammunition", fill = I("light blue"), col = I("red"), aplpha = .2, xlim = c(0, 1))

##pEnC

boxplot(MCClist$pEnC, col=(c("pink", "pink")), main = "Platform Portfolio: Electronics and Communication", xlab = "dollars spent on Electronics and Communication", horizontal = TRUE)
...
boxplot(MCClist$pIDV, col=(c("light purple", "light purple")), main = "Contracting Methods: Contract Vehicle", xlab = "dolalrs spent on Contract Vehicle", horizontal = TRUE)
...
##residual plot
jfit1.res <- resid(jfit1)

jfit1.yhat <- predict(jfit11)

plot1 <- scatterplot(jfit1.yhat, jfit1.res, title = "Residuals vs. Fitted", xlab = "Fitted Values", ylab = "Residuals")

plot(MCClist$pEffectiveComp, jfit1.res, ylab = "Residuals", xlab = "Effective Competition",  main = "Residuals")
abline(0, 0)
